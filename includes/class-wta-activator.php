...
class WTA_Activator {
	...
	private static function set_default_prompts() {
		...
		add_option( 'wta_prompt_continent_cities_system', 'Du er ekspert i verdens storbyer og deres tidszoner. Skriv engagerende om byer og deres lokale tid. VIGTIG: KUN ren tekst, ingen overskrifter, ingen markdown, ingen lister. Du må bruge shortcodes. Alle sætninger SKAL afsluttes korrekt.' );
		add_option( 'wta_prompt_continent_cities_user', 'Skriv et afsnit på 100-120 ord om de største byer i {location_name_local} og deres tidszoner. Beskriv kort: Hvilke tidszoner de ligger i, Hvordan tiden adskiller sig mellem byerne (hvis relevant), Interessante tidszone-aspekter for rejsende. VIGTIGT: Afslut afsnittet med en liste over de største byer med aktuel tid ved at bruge shortcodes. For hver by i listen {cities_list}, indsæt shortcoden [wta_city_time city="BYNAVN"] på en ny linje. Eksempel: Hvis {cities_list} indeholder "London, Paris, Berlin", skal du afslutte med tre linjer: [wta_city_time city="London"], [wta_city_time city="Paris"], [wta_city_time city="Berlin"]. KUN ren tekst + shortcodes - ingen overskrifter, ingen punktopstillinger. Kontekst: {cities_list}' );
