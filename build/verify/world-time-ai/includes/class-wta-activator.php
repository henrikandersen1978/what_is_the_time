...
class WTA_Activator {
	 ...
	 * 
	 * IMPORTANT: This uses add_option() which will NOT overwrite existing values.
	 * This ensures user settings are preserved during plugin updates.
	 *
	 * @since 1.0.0
	 */
	private static function set_default_options() {
		// GitHub data source URLs (default to dr5hn/countries-states-cities-database)
		// Note: add_option() only adds if option doesn't exist - preserves user settings
